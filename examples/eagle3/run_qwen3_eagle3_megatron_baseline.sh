...
# ===== vLLM configuration =====
export VLLM_USE_V1=1  # Enable vLLM V1 engine (required for EAGLE3 with vLLM-Ascend)
...
DRAFT_PATH=${DRAFT_PATH:-/home/weight/Qwen3-a3B_eagle3}
...
max_response_length=${MAX_RESPONSE_LENGTH:-2048}  # OOM: 长序列 → gather 峰值高
